...
import { addPhone, deletePhoneByIndex, deletePhoneByName, filter5G, filterPriceLessThan, filterPriceGreaterThan, findPhoneByName, calcAverageCost, doWeHaveA5GPhone, phoneFlashSale, phoneFlashSaleV2 } from "./src/models/Warehouse";
